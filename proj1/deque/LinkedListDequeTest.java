...
public class LinkedListDequeTest {
    ...
    @Test
    /* Tests whether get method is valid */
    public void getElementTest() {
        ...
        System.out.println("The 1th element is "+lld1.get(0));
        assertEquals(lld1.get(0),lld1.getRecursive(0));
        System.out.println("The 2th element is "+lld1.get(1));
        assertEquals(lld1.get(1),lld1.getRecursive(1));
        System.out.println("The 3th element is "+lld1.get(2));
        assertEquals(lld1.get(2),lld1.getRecursive(2));
        System.out.println("The 4th element is "+lld1.get(3));
